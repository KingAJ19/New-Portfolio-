    ...
    <v-container class="my-6">
      <v-layout row wrap>
        <v-flex xs12 sm6 md4 lg3 v-for="project in projects" :key="project.name" link :to="project.github + project.link">
          <v-card height="96%" width="auto" text class="text-center ma-3 animate__animated animate__rollIn">
...
import {mdbContainer, mdbRow, mdbCol} from 'mdbvue';
    ...
    return{
      projects: [
        ...
        { name: 'My Anime Site', description: 'A website with my anime lists and rankings', avatar: '/ryuuk.gif', link: 'https://aneles-anime-webpage.herokuapp.com', github: 'https://github.com/KingAJ19/Anime-Site' },
        { name: 'YouTube Clone', description: 'A YouTube clone made with HTML , CSS and Javascript', avatar: '/youtube.gif', link: 'https://aneles-youtube-clone.netlify.app', github: 'https://github.com/KingAJ19/YouTube-Clone' },
        { name: 'Codex Site', description: 'A coding company site made with HTML, CSS & JQuery', avatar: './coding.gif', link: 'https://codex-company.netlify.app', github: 'https://github.com/KingAJ19/Flexbox-Website' },
        { name: 'JS Shopping Cart', description: 'A shopping cart made with HTML, CSS & Javascript', avatar: './js.gif', link: 'https://aneles-js-shopping-cart.netlify.app', github: 'https://github.com/KingAJ19/JS-Shopping-Cart' },
        ...
        { name: 'Music List App', description: 'A music list app made with HTML, CSS and Owl Carousel', avatar: './music.gif', link: 'https://music-list-app.netlify.app', github: 'https://github.com/KingAJ19/Music-App' },
        ...
        { name: 'Twitter Clone', description: 'A Twitter UI clone made with HTML & CSS', avatar: './twitter.gif', link: 'https://aneles-twitter-clone.netlify.app', github: 'https://github.com/KingAJ19/Twitter-Clone' },
        ...
        { name: 'Anime Search Filter', description: 'A in-page filtered search with vanilla Javascript', avatar: './search.gif', link: 'https://anime-search-filter.netlify.app', github: 'https://github.com/KingAJ19/Search-Filter' },
